        ...
        {messages.map((msg, index) => {
          ...
          return (
            ...
            {/* <div className="chat-header mb-1 text-xs">
              ...
              <div
                className={`chat-bubble shadow-lg rounded-3xl max-w-[80%] md:max-w-[70%] break-words ${
                  isMe
              ...
              >
                <div className="flex flex-wrap items-end gap-2">
                  ...
                  <span className="text-[10px] opacity-70 self-end ml-auto whitespace-nowrap">
                    {msg.createdAt
